...
{
   // public delegate void FilesDbUpDate();

  //  public delegate void FileSearch(string fullPath);

    public static class FileSearcher
    {
        //   public event Action<Food> FoodSearchHandler;
        //    public static event FilesDbUpDate FilesDbUpDateHandler;
        public static event Action  FilesDbUpDateHandler;

     //   public static event FileSearch FileSearcherHandler;
